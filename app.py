...
def process_bom(df_v, df_d, df_p):
    ...
    if not df_procesados_a_explotar.empty:
        ...
        m2 = pd.merge(df_procesados_a_explotar, df_p_clean, left_on='SKU', right_on='COD_P', how='left')
        ...
        def calcular_m2(row):
            if row['MARK_P'] == 1:
                ...
                # Caso Mechada o Lotes: CantEfic / CantReceta
                divisor = row['CR_P'] if row['CR_P'] > 0 else 1

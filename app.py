            ...
            if st.session_state.get('vd_excel_fecha') and st.session_state.get('vd_excel_data') is None:
                with st.spinner("Generando informe..."):
                    ...
                    try:
                        ...
                        fig1, ax1 = _plt.subplots(figsize=(14.5, 3.2), facecolor=_BG)
                        ...
                        fig1.tight_layout()
                        _insert_img(_ws_out, _img_bytes(fig1), 'C59', 1396, 304)
                        ...
                        fig2, ax2 = _plt.subplots(figsize=(5.2, 3.2), facecolor=_BG)
                        ...
                        fig2.tight_layout()
                        _insert_img(_ws_out, _img_bytes(fig2), 'S59', 666, 304)
                        ...
                        fig3, ax3 = _plt.subplots(figsize=(6.9, 3.2), facecolor=_BG)
                        ...
                        ax3.set_title('PARTICIPACIÓN DELIVERY APPS',
                                      color='white', fontsize=10, fontweight='bold', pad=10)
                        fig3.tight_layout()
                        _insert_img(_ws_out, _img_bytes(fig3), 'N59', 500, 304)
                        ...
                        fig4, ax4 = _plt.subplots(figsize=(17.3, 3.2), facecolor=_BG)
                        ...
                        fig4.tight_layout()
                        _insert_img(_ws_out, _img_bytes(fig4), 'Y59', 1661, 304)
